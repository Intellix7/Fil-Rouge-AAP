...
int main() {
    ...
    char * t2 = "mot:anagramme 1:anagramme 2:anagramme 3:anagramme 4:anagramme 5:anagramme 6:anagramme 7:anagramme 8:anagramme 9:anagramme 10:anagramme 11:anagramme 12:anagramme 13";
    char * t3 = "pomme:banane:poire:litchi";
    split(':', t2, MAXFIELDS, data.key, field_table);
    data.fieldNames = field_table;
    // printf("%s", data.fieldNames[2]);

    // split(':', t3, MAXFIELDS, key, field_table);
    // printf("%p\n", key);
